    ...
    <div className="w-full bg-white text-black">
      ...
      >
        ...
        <motion.img
          src="download.gif"
          alt="Logo Animation"
          className="h-75 w-75 object-contain mt-10"
          variants={childVariants}
      ...
      <motion.div
        className="flex justify-between items-start p-16 mt-20 mr-30"
        variants={sectionVariants}
        initial="hidden"
        animate="visible"
      >
        {/* Left Side: Overview */}
        <motion.div className="w-1/3" variants={textVariants}>
          <p className="text-sm font-bold ml-40">Overview</p>
        </motion.div>

        {/* Right Side: Description and Services */}
        <motion.div className="w-2/3 pl-16" variants={textVariants}>
          <p className="text-4xl font-extrabold mr-40">
            EduLearn AI is an AI-powered educational platform designed to enhance the learning experience.
          </p>
          <p className="text-2xl font-semibold mt-6 mr-40">Services</p>
          <motion.ul className="list-disc text-lg pl-6 mt-4 mr-40">
            {[
      ...
      {/* Glow Automation GIF */}
      <motion.div
        className="flex justify-center mr-40"
      ...
      >
        ...
        <motion.div className="w-1/3" layout>
          <p className="text-sm font-bold ml-40">In Detail</p>
        </motion.div>

        {/* Right Side: Detailed Description */}
        <motion.div className="w-2/3 pl-16" layout>
          {/* Task Section */}
          <motion.h3 className="text-2xl text- black font-extrabold mr-40" layout>
            Task
          </motion.h3>
          <motion.p className="text-lg mt-4 mr-40" layout>
          ...
          {/* Solutions Section */}
          <motion.h3 className="text-2xl font-extrabold mt-8 mr-40" layout>
            Solutions
          </motion.h3>
          <motion.p className="text-lg mt-4 mr-40" layout>
          ...
          {/* For Students */}
          <motion.h4 className="text-xl font-semibold mt-6 mr-40" layout>
            For Students
          </motion.h4>
          <motion.ul className="list-disc text-lg pl-6 mt-4 mr-40" layout>
...
<div className="bg-white text-black py-16 mt-20">
  ...
  >
    {/* Left Side: Overview */}
    <motion.div className="w-1/3" variants={textVariants}>
          <p className="text-sm font-bold ml-40 mb-40">Features</p>
        </motion.div>

    <div className="overflow-hidden w-full">
      <motion.div
        className="flex space-x-8"
        animate={{ x: "-100%" }} // Slide from right to left
        transition={{
          repeat: Infinity, // Infinite loop
          duration: 25, // Slower animation
          ease: "linear", // Smooth constant speed
        }}
        style={{ display: "flex", width: "max-content" }} // Ensure horizontal scroll
      >
        {[
          {
          ...
          <motion.div
            key={index}
            className="feature-card p-6 bg-white-800 rounded-lg shadow-lg text-left flex flex-col justify-center"
            whileHover={{ scale: 1.05 }} // Add hover effect for interactivity
            style={{ minWidth: "220px", minHeight: "320px" }} // Reduced width, increased height
          >
      ...
      {/* Results Section */}
<motion.div
  className="bg-white text-black py-16 px-10 mt-20 mr-30 rounded-xl shadow-lg"
  initial="hidden"
  whileInView="visible"
  viewport={{ once: true, amount: 0.3 }}
  variants={containerVariants}
>
  <div className="flex justify-between items-start p-16 mt-20 mr-30">
    {/* Left Side: Results Title (Fixed) */}
    {/* Left Side: Overview */}
    <motion.div className="w-1/3" variants={textVariants}>
          <p className="text-sm font-bold ml-40">Results</p>
        </motion.div>

    {/* Right Side: Description */}
    <div className="md:w-2/3 w-full pl-6">
      <motion.p className="text-4xl md:text-5xl font-extrabold mb-6 text-gray-900" variants={textVariants}>
        EduLearn AI brings impactful results to the education sector.
      </motion.p>
      <motion.p className="text-lg text-gray-600 mb-6" variants={textVariants}>
      ...
      <motion.ul className="space-y-4 text-lg text-gray-800 pl-8 list-none" variants={containerVariants}>
